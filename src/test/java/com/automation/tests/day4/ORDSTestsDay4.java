...
public class ORDSTestsDay4 {
    ...
    public void test1() {
        given().
                ...
                assertThat().time(lessThan(3L), TimeUnit.SECONDS).
                log().all(true);
        /*
        Vasyl's solution:
    ...
    public void test2() {
        given().
                accept(ContentType.JSON).pathParam("id", "US").
                when().
                get("/countries/{id}").
                then().
                assertThat().statusCode(200).
    ...
    public void test5() {
        List<String> countries = List.of("Argentina", "Brazil", "Canada", "Mexico", "United States of America");
    ...
    public void test6() {
        ...
        // whenever we specify path as items.salary, you will get collection of salaries
        // then to check every dingle value,
        // we can use everyItem(greaterThan()).
    }
    ...
    public void test8() {
        ...
        List<Integer> salaries = given().accept(ContentType.JSON).
                when().
                get("/employees").
        ...
        assertEquals(expectedSalaries, salaries);
    }

    @Test
    @DisplayName("Test 8 vasyl's solution")
    public void test9() {
        List<Integer> expectedSalaries = List.of(24000, 17000, 17000, 12008, 11000,
                9000, 9000, 8200, 8200, 8000,
                7900, 7800, 7700, 6900, 6500,
