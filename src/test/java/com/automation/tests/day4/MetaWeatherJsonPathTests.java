...
public class MetaWeatherJsonPathTests {
    ...
    @Test
    @DisplayName("Verify that 5 cities contain New ")
    public void test1(){
        Response response =
        given().
        ...
        List<?> list = response.jsonPath().getList("items");
    ...
    @Test
    @DisplayName("Verify that cities that contain 'las' has location_type as City")
    public void test4(){
        given().
                accept(ContentType.JSON).
                queryParam("query","Las").
    ...
    @DisplayName("Verify that ")
    public void test5(){
        List<String> list = List.of("BBC","Forecast.io","HAMweather","Met Office","OpenWeatherMap",
