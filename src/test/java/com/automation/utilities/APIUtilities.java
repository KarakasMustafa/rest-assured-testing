...
public class APIUtilities {
    ...
    private static String URI = ConfigurationReader.getProperty("spartans.uri");
    /**
     * This method can POST a new spartan
     * @param spartan POJO
    ...
    public static Response postSpartan(Map<String, ?> spartan){
        RestAssured.baseURI = ConfigurationReader.getProperty("spartans.uri");
    ...
    public static Response deleteSpartanById(int id){
        RestAssured.baseURI = ConfigurationReader.getProperty("spartans.uri");
        return when().delete("/spartans/{id}",id);
    }
